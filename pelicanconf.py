...
AUTHOR          = 'issacabraham'  # use your name
SITENAME        = 'My Python Notes' # use title
GITHUB_USERNAME = 'issac-abraham' # use your username
...
# Social widget
SOCIAL = (
    ("GitHub", "https://github.com/dissacabraham-Leviathan"),
    ("LinkedIn", "linkedin.com/in/issac-abraham-8932ba326"),
)
